...
/**
 * COMPONENT: LỐC LỊCH XÉ TRUYỀN THỐNG (MINIMALIST & REFINED)
 */
  ...
  return (
    <div className="lvs-tear-calendar-card">
      ...
      <div className="tear-cal-body">
        ...
        {/* Khối Âm Lịch Liền Mạch (Không hộp trong hộp) */}
        <div className="tear-lunar-streamlined">
          ...
          <div className="lunar-right-block">
            ...
            <div className="canchi-aligned-row">
              ...
              <span className="canchi-value">{canChi.day.fullName}</span>
...
export default DailyTearCalendar;
